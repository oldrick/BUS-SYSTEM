...
class DriverController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            Yii::$app->session->setFlash('driverAdded','The driver was added successfully');
            return $this->redirect(['index']);
        } else { //this one will never occur since all the form's fields are required.
            Yii::$app->session->setFlash('driverNotAdded','Error adding the driver');
